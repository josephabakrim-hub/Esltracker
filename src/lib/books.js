...
export const BOOKS = {
  ...
  kidsboxng5: {
    slug: 'kidsboxng5',
    label: 'Kids Box NG — Level 5',
    series: 'Kids Box New Generation',
    track: 'pro',
    cefr: 'A2 (Flyers)',
    color: '#0ea5e9',
    units: [
      { num: 1, title: 'Time for Television', emoji: '📺' },
      { num: 2, title: 'People at Work',       emoji: '👷' },
      { num: 3, title: 'City Life',            emoji: '🏙️' },
      { num: 4, title: 'Disaster!',            emoji: '🌪️' },
      { num: 5, title: 'Material Things',      emoji: '🧵' },
      { num: 6, title: 'Senses',               emoji: '👃' },
      { num: 7, title: 'Natural World',        emoji: '🌿' },
      { num: 8, title: 'World of Sport',       emoji: '🏆' },
    ],
    spinQuestions: [],
    homework: [],
    materials: [],
  ...
  kidsboxng6: {
    slug: 'kidsboxng6',
    label: 'Kids Box NG — Level 6',
    series: 'Kids Box New Generation',
    track: 'pro',
    cefr: 'A2 (Flyers)',
    color: '#14b8a6',
    units: [
      { num: 1, title: 'Beastly Tales',        emoji: '🐉' },
      { num: 2, title: "Tomorrow's World",     emoji: '🚀' },
      { num: 3, title: 'The Great Outdoors',   emoji: '🏕️' },
      { num: 4, title: 'Food, Glorious Food!', emoji: '🍲' },
      { num: 5, title: 'Under the Sea',        emoji: '🐠' },
      { num: 6, title: 'Free Time',            emoji: '🎮' },
      { num: 7, title: 'Fashion Sense',        emoji: '👗' },
      { num: 8, title: 'Around the World',     emoji: '🌍' },
    ],
    spinQuestions: [],
    homework: [],
    materials: [],
  ...
  think1: {
    slug: 'think1',
    label: 'Think — Level 1',
    series: 'Cambridge Think (1st edition)',
    track: 'elite',
    cefr: 'A2',
    color: '#f97316',
    units: [
      { num: 1,  title: 'Having Fun',              emoji: '🎈' },
      { num: 2,  title: 'Money and How to Spend It', emoji: '💰' },
      { num: 3,  title: 'Food for Life',            emoji: '🍽️' },
      { num: 4,  title: 'Family Ties',              emoji: '👨‍👩‍👧' },
      { num: 5,  title: 'It Feels Like Home',       emoji: '🏠' },
      { num: 6,  title: 'Best Friends',             emoji: '🤝' },
      { num: 7,  title: 'The Easy Life',            emoji: '🛋️' },
      { num: 8,  title: 'Sporting Moments',         emoji: '⚽' },
      { num: 9,  title: 'The Wonders of the World', emoji: '🌍' },
      { num: 10, title: 'Around Town',              emoji: '🏙️' },
      { num: 11, title: 'Future Bodies',            emoji: '🏥' },
      { num: 12, title: "Travellers' Tales",        emoji: '✈️' },
    ],
    spinQuestions: [],
    homework: [],
    materials: [],
